...
export const CONTENT_CATEGORIES = [
  ...
  'java-expansion-024.json',
  'java-expansion-025.json',
  'java-expansion-026.json',
  'java-expansion-027.json',
  'java-expansion-028.json',
  'java-expansion-029.json',
  'java-expansion-030.json',
  'java-expansion-031.json',
  'java-expansion-032.json',
  'java-expansion-033.json',
  'java-expansion-034.json',
  'java-expansion-035.json',
  'java-expansion-036.json',
  'java-expansion-037.json',
  'java-expansion-038.json',
  'java-expansion-039.json',
  'java-expansion-040.json',
  'java-expansion-041.json'
];
