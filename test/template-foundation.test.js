...
test('JavaAtlas loads the Java content corpus shards', () => {
  assert.deepEqual(CONTENT_CATEGORIES, ['java-core.json', 'java-expansion-001.json', 'java-expansion-002.json', 'java-expansion-003.json', 'java-expansion-004.json', 'java-expansion-005.json', 'java-expansion-006.json', 'java-expansion-007.json', 'java-expansion-008.json', 'java-expansion-009.json']);
});
